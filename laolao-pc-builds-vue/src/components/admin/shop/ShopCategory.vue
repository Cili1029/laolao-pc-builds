                            ...
                            <DialogFooter>
                                <DialogClose as-child>
                                    <Button type="submit" @click="add()"
                                        :disabled="newCategory.productType === -1 || newCategory.image.length === 0 || newCategory.name === ''">
                                        添加
                                    </Button>
                                </DialogClose>
                            </DialogFooter>
...
<script setup lang="ts">
    ...
    const update = async (id: number) => {
        try {
            ...
            category!.productType = updateData.value.productType
